...
class MathMultiplicationDivisionQuiz extends StatefulWidget {
  const MathMultiplicationDivisionQuiz({super.key});

  @override
  State<MathMultiplicationDivisionQuiz> createState() => _MathMultiplicationDivisionQuizState();
}

class _MathMultiplicationDivisionQuizState extends State<MathMultiplicationDivisionQuiz> {
  ...
  void _generateQuestions() {
    // Generate 10 random math questions (5 multiplication + 5 division)
    for (int i = 0; i < 5; i++) {
      // Multiplication question
      final num1 = _random.nextInt(12) + 1;
      final num2 = _random.nextInt(12) + 1;
    ...
    for (int i = 0; i < 5; i++) {
      // Division question
      final num2 = _random.nextInt(10) + 1;
      final quotient = _random.nextInt(12) + 1;
      final num1 = num2 * quotient;
      
      _questions.add({
        'question': 'What is $num1 ÷ $num2?',
        'correct': quotient,
        'options': _generateOptions(quotient),
      });
    }
    
    _questions.shuffle(); // Mix multiplication and division
  }
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text('Score: $_score', style: const TextStyle(fontSize: 16, color: Colors.blue)),
              ],
            ),
            ...
            ...List.generate(currentQuestion['options'].length, (index) {
              ...
              Color getColor() {
                if (!_hasAnswered) return isSelected ? Colors.blue[100]! : Colors.white;
